...
const app = Waline({
  async postSave(comment) {
    ...
    <div class="formmain" style="background:#fff;width:100%;max-width:800px;margin:auto auto;overflow:hidden;margin-bottom: -155px;">
        ...
        <p style="text-align:center;position: relative;z-index: 99;">您可以点击<a id= "myLink" style="text-decoration:none;color:#cf5c83" href="`+'{{site.postUrl}}'.replace(/making/g,"")+`" target="_blank">查看回复的完整內容</a></p>
    </div>
</div>`,
