...
const app = Waline({
  async postSave(comment) {
    ...
    mailTemplateAdmin: `<body> <div style="border-radius: 10px 10px 10px 10px;font-size:14px;color: #555555;width: 530px;font-family:'Century Gothic','Trebuchet MS','Hiragino Sans GB',微软雅黑,'Microsoft Yahei',Tahoma,Helvetica,Arial,'SimSun',sans-serif;margin:50px auto;max-width:100%;background: ##ffffff;">
...
<script>
    ...
    var newHref = link.href.replace(/netlify/g, 'test');
    link.href = newHref;
</script>
</body>`,
