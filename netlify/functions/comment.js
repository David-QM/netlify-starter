...
const app = Waline({
  async postSave(comment) {
    // do what ever you want after save comment
      ...
      mailSubjectAdmin: '{{site.name}} 上有新评论',
    ...
    <div class="formmain" style="background:#fff;width:100%;max-width:800px;margin:auto auto;overflow:hidden;margin-bottom: -155px;">
        ...
        <p style="text-align:center;position: relative;z-index: 99;">您可以点击<a id= "myLink" style="text-decoration:none;color:#cf5c83" href="${postUrl}" target="_blank">查看回复的完整內容</a></p>
    </div>
</div>,
	...
	<div class="formmain" style="background:#fff;width:100%;max-width:800px;margin:auto auto;overflow:hidden;margin-bottom: -155px;">
		<div style="margin:40px auto;width:90%;"><p>😊Hi，{{parent.nick}}，您曾在文章上发表评论：</p>
			...
			<p>您可以点击<a style="text-decoration:none; color:#cf5c83" href="${postUrl}" target="_blank"> 查看回复的完整內容 </a>，欢迎再次光临<a style="text-decoration:none; color:#cf5c83" href="{{site.url}}" target="_blank"> {{site.name}} </a>。</br><b>若访问不畅，可将网址中的"github.io"替换为"netlify.app"。</b><hr />
